...
const functions = [ // this is making the 3 cards which play the video area below the description
  {
    title: "Listen",
...
export function FunctionsGrid() { // main exported component which is used in page.tsx
  return (
    <section 
      id="experience"  // section id for navigation and linking
      className="py-[80px] lg:py-[240px] bg-background"
    >
      <div className="container">
        {/* Section Heading */}
        <motion.h3 // this animates the h3 element from framer motion
          initial={{ opacity: 0, y: 50 }} // starts invisible and pushed down
          whileInView={{ opacity: 1, y: 0 }} // animates into place when scrolled into view
          transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }} // smooth cinematic easing curve
        ...
        {/* Functions Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8"> // createws 1 column on mobile, 2 on tablets and 3 on desktop
