        ...
        {cards.map((card, index) => (
          ...
          >
            <div className="container flex flex-col lg:flex-row items-center gap-10 lg:gap-20 py-10">
              ...
              {/* Left Side: Info & Chat */}
              <div className="flex-1 flex flex-col justify-center h-full max-w-[600px] order-2 lg:order-1">
                <motion.div 
              ...
              <motion.div 
                ...
                viewport={{ once: false, amount: 0.5 }}
                className="flex-1 w-full h-[40vh] lg:h-[70vh] relative order-1 lg:order-2"
              >
